...
//                     <SubType title="Free" src={chopp} text="We have a big selection of tasty recipes that you can try out." />
//                     <SubType title="Subscribed" src={fajitas} text="When you decide to subscribe, you will have acces to even more recipes, you will be able to add your own tried and tested recipes." />
//                 </div>
