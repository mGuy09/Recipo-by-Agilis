...
const IngredientLabel = ({text, categoryId, ClickHandler}) => {

  return (
    <div>
        <input onChange={ClickHandler} data-category-id={categoryId}  type="checkbox" className='hidden peer checkmark' id={text}/>
