    ...
    <div>
      <form className='flex flex-col items-center' onSubmit={LoginUser}>
        ...
        <div className='flex flex-col gap-2 my-2 items-center'>
          ...
          {emailError ? <p className='flex gap-1 items-center mx-2 text-red-500'><AiOutlineExclamationCircle/> Invalid Email Address</p> : null}
          ...
          <div className='flex flex-col '>
          {passwordError ? <p className='flex gap-1 items-center mx-2 text-red-500'><AiOutlineExclamationCircle/> Invalid Password</p> : null}
          ...
          <Link className='text-orange-500 hover:text-orange-400 active:text-orange-700 underline mb-3 underline-offset-2'>forgot password?</Link>
        </div>
