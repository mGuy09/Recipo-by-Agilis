...
const LoginForm = () => {
  ...
  const LoginUser = async (e) => {
    ...
    console.log(data);
    await axios.post(apiUrl, data, {Credentials: 'allow'}).then((result) => {
      console.log(result);
  ...
  return (
    <div>
      ...
      <form className='flex flex-col items-center' onSubmit={LoginUser}>
        ...
        <button type='submit' className='bg-orange-500  mx-2 text-white hover:bg-orange-400 active:bg-orange-600 rounded-full px-6 py-2 duration-300'>Login</button>
      </form>
