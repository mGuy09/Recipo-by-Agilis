...
const PremiumDashboardSection = () => {
  return (
    <div className='bg-black p-10 flex justify-around items-center gap-32'>
        ...
        <Link className='bg-emerald-500 text-white hover:shadow-lg hover:shadow-emerald-400/60 py-4 px-6 rounded-full text-xs sm:text-base lg:text-lg font-medium flex items-center hover:scale-105 hover:bg-emerald-400 ease-linear duration-150 active:bg-emerald-700' to='/Add-Recipe' ><IoMdStar size={18} className='mr-2'/> Add Recipe</Link>
    </div>
  )
}
