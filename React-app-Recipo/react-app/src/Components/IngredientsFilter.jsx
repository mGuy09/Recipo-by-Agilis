...
const IngredientsFilter = (props) => {
  ...
  return (
    ...
    {<div className={filterDropdown || isLarge ? 'flex gap-10 justify-center duration-300 flex-wrap py-7 mx-10 border-b border-b-gray-400 z-0' : 'hidden'}>
            ...
            <div>
                <input type="radio" id='allingredientsfilter' name='ingredientsfilter' className='hidden peer'/>
            ...
            <div>
                <input type="radio" id='dairyfilter' name='ingredientsfilter' className='hidden peer'/>
            ...
            <div>
                <input type="radio" id='meatsfilter' name='ingredientsfilter' className='hidden peer'/>
            ...
            <div>
                <input type="radio" id='veggiefilter' name='ingredientsfilter' className='hidden peer'/>
            ...
            <div>
                <input type="radio" id='herbsfilter' name='ingredientsfilter' className='hidden peer'/>
            ...
            <div>
                <input type="radio" id='condimentsfilter' name='ingredientsfilter' className='hidden peer'/>
            ...
            <div>
                <input type="radio" id='grainsfilter' name='ingredientsfilter' className='hidden peer'/>
